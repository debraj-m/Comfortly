...
import { getUserFromSupabase } from "@/app/chat/actions";
    ...
    <div className="flex min-h-screen w-full bg-[#1a1a1a]">
      ...
      <aside className="h-full w-16 flex flex-col items-center py-4 bg-transparent border-r border-[#232323]">
        ...
        <div className="flex-1 flex flex-col items-center gap-4 mt-2">
          ...
          <button onClick={() => console.log("Settings clicked")} className="w-8 h-8 flex items-center justify-center rounded-md hover:bg-[#232323] transition-colors" aria-label="Settings">
